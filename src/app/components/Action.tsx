...
export const Action = (props: {currentView: string, db: any, selectionData: any, user: any, updated: number}) => {
    ...
    const view:any = {"inspector": <Inspector updated={updated} db={db} selectionData={selectionData} readOnly={readOnly} />, "meta": <Meta data={db} />, "library": <Library db={db} readOnly={readOnly} />, "settings": <Settings user={user}/> }[currentView || "inspector"];
    return (
