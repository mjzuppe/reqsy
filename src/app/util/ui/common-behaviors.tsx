export const commonBehaviors = [
    ...
    {
        "element": "input",
        "attributes": ["type", "name", "value", "placeholder", "maxlength", "size", "checked", "disabled", "readonly", "required", "pattern", "autocomplete", "autofocus"],
        "eventHandlers": ["onChange", "onClick", "onKeyDown", "onBlur", "onFocus"]
    },
    {
        "element": "button",
        "attributes": ["type", "name", "value", "form", "formaction", "formmethod", "formenctype", "formnovalidate", "formtarget", "autofocus", "disabled"],
        "eventHandlers": ["onClick", "onKeyDown", "onContextMenu"]
    },
    {
        "element": "form",
        "attributes": ["action", "method", "enctype", "name", "id", "target", "accept-charset", "autocomplete", "novalidate", "onsubmit", "onClick", "onReset"]
    },
    {
        "element": "label",
    ...
    {
        "element": "textarea",
        "attributes": ["name", "rows", "cols", "maxlength", "placeholder", "readonly", "disabled", "required", "autofocus", "onChange", "onClick", "onKeyDown"]
    },
    {
        "element": "table",
